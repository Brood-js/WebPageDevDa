...
const MissionVision = () => {
    return (
        <div className={style.container_mision_vision}>
                ...
                <div className={style.mision}>
                    <div className={style.cont_mision_v}>
                        ...
                        <div className={style.info_mision_vision}>
                            ...
                            <p className={style.p_m_v}>En Devdatep, tenemos como misión proporcionar soluciones tecnológicas y eficaces para nuestros clientes a travéz del desarrollo de software a medida.</p>
                        </div>
                    </div>
                </div>
                <div className={style.vision}>
                    <div className={style.cont_mision_v}>
                        ...
                        <div className={style.info_mision_vision}>
                            ...
                            <p className={style.p_m_v}>Nuestra vision es hacer a la empresa y ser lideres y ser lideres en el sector de la tecnologia, brindando las soluciones adecuadas en relacion con las necesidades de nuestros clientes</p>
                        </div>
                    </div>
                </div>
            </div>
